...
export default function Oferta(props) {
  ...
  const onSubmit = (e) => {
    ...
    form.checkValidity() 
    setValidated(true)
    crearOferta(props.userPerfil?.uid,user.uid,{descripcion : descripcion.value,disponible : horario2, precio : props.userPerfil?.precio, estado : "enviado"})
  ...
  return (
    <Modal.Dialog>
      ...
      <Modal.Body>
        <Form onSubmit={onSubmit} id="CreateForm" noValidate validated={validated}>
              ...
              return (
                <tr>
                  ...
                  {horario.map((hour) => {
                    return (
                      <th>
                        {props.userPerfil?.horario?.find((e) => e === day + hour) && (
                          <Form.Check
                          type="checkbox"
                          value={day + hour}
                          name="horario"
          ...
          <Form.Group controlId="description">
            ...
            <Form.Control as="textarea" rows={5} name="descripcion" required minLength={20} placeholder="Escribe que tiene que hacer o como puede contactar contigo."/>
          </Form.Group>
        </Form>
      </Modal.Body>
